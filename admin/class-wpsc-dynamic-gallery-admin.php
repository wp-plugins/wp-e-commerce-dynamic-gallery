...
class WPSC_Settings_Tab_Gallery_Settings {
	...
	function wpsc_dynamic_gallery_extension() {
		$html = '';
		$html .= '<div id="wpsc_dynamic_gallery_extensions">'.__('Introductory Offer! Activate these 22 advanced features with', 'wpsc_dgallery').' <a target="_blank" href="http://a3rev.com/products-page/wp-e-commerce/wp-e-commerce-dynamic-gallery/">'.__('WP e-Commerce Dynamic Gallery Pro', 'wpsc_dgallery').'</a> '.__('for just a tiny', 'wpsc_dgallery').' <strong>$5</strong> - '.__("Offer won't last, grab it while you can!", 'wpsc_dgallery').'</div>';
		return $html;	
	}
}
?>
