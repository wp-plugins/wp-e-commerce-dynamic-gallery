...
class WPSC_Dynamic_Gallery_Admin_Interface extends WPSC_Dynamic_Gallery_Admin_UI
{
	...
	public function get_success_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully saved.' , 'wpsc_dgallery' ); 
	...
	public function get_error_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Error: Settings can not save.' , 'wpsc_dgallery' ); 
	...
	public function get_reset_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully reseted.' , 'wpsc_dgallery' ); 
		return '<div class="updated" id=""><p>' . $message . '</p></div>';
	}
	...
	public function get_font_weights() {
		$font_weights = array (
			'300'				=> __( 'Thin', 'wpsc_dgallery' ),
			'300 italic'		=> __( 'Thin/Italic', 'wpsc_dgallery' ),
			'normal'			=> __( 'Normal', 'wpsc_dgallery' ),
			'italic'			=> __( 'Italic', 'wpsc_dgallery' ),
			'bold'				=> __( 'Bold', 'wpsc_dgallery' ),
			'bold italic'		=> __( 'Bold/Italic', 'wpsc_dgallery' ),
		);
	...
	public function get_border_styles() {
		$border_styles = array (
			'solid'				=> __( 'Solid', 'wpsc_dgallery' ),
			'double'			=> __( 'Double', 'wpsc_dgallery' ),
			'dashed'			=> __( 'Dashed', 'wpsc_dgallery' ),
			'dotted'			=> __( 'Dotted', 'wpsc_dgallery' ),
			'groove'			=> __( 'Groove', 'wpsc_dgallery' ),
			'ridge'				=> __( 'Ridge', 'wpsc_dgallery' ),
			'inset'				=> __( 'Inset', 'wpsc_dgallery' ),
			'outset'			=> __( 'Outset', 'wpsc_dgallery' ),
		);
		...
		foreach ( $options as $value ) {
			...
			switch( $value['type'] ) {
							...
							<fieldset>
								...
								if ( is_array( $value['onoff_options'] ) && count( $value['onoff_options'] ) > 0 ) {
									foreach ( $value['onoff_options'] as $i_option ) {
										if ( ! isset( $i_option['checked_label'] ) ) $i_option['checked_label'] = __( 'ON', 'wpsc_dgallery' );
										if ( ! isset( $i_option['unchecked_label'] ) ) $i_option['unchecked_label'] = __( 'OFF', 'wpsc_dgallery' );
				...
				case 'onoff_checkbox' :
					...
					if ( ! isset( $value['checked_value'] ) ) $value['checked_value'] = 1;
					if ( ! isset( $value['checked_label'] ) ) $value['checked_label'] = __( 'ON', 'wpsc_dgallery' );
					if ( ! isset( $value['unchecked_label'] ) ) $value['unchecked_label'] = __( 'OFF', 'wpsc_dgallery' );
				...
				case 'image_size' :
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo sanitize_title( $value['type'] ) ?>">
							...
							<label><?php _e( 'Height', 'wpsc_dgallery' ); ?> <input name="<?php echo $name_attribute; ?>[height]" id="<?php echo $id_attribute; ?>-height" type="text" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-height" value="<?php echo $height; ?>" /></label>
	
							<label><?php _e( 'Hard Crop', 'wpsc_dgallery' ); ?> <input name="<?php echo $name_attribute; ?>[crop]" id="<?php echo $id_attribute; ?>-crop" type="checkbox" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-crop" <?php echo $crop; ?> /></label>
						...
						<td class="forminp">
                           ...
                           <!-- Font Face -->
							<select
								...
								>
								<optgroup label="<?php _e( '-- Default Fonts --', 'wpsc_dgallery' ); ?>">
                                <?php
                                ...
                                <optgroup label="<?php _e( '-- Google Fonts --', 'wpsc_dgallery' ); ?>">
                                <?php
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-typography-preview"><a href="#" class="a3rev-ui-typography-preview-button button submit-button" title="<?php _e( 'Preview your customized typography settings', 'wpsc_dgallery'); ?>"><span>&nbsp;</span></a></div>
				...
				case 'border':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-border_corner">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border settings', 'wpsc_dgallery'); ?>"><span>&nbsp;</span></a></div>
                           ...
                           <!-- Border Corner : Rounded or Square -->
								<input
                                    ...
                                    checked_label="<?php _e( 'Rounded', 'wpsc_dgallery' ); ?>"
                                    unchecked_label="<?php _e( 'Square', 'wpsc_dgallery' ); ?>"
                                    type="checkbox"
                                    value="rounded"
				...
				case 'border_styles':
					...
					?><tr valign="top">
						...
						<td class="forminp">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border styles settings', 'wpsc_dgallery'); ?>"><span>&nbsp;</span></a></div>
                           </div>
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-box_shadow">
                            ...
                            <input
                                    ...
                                    checked_label="<?php _e( 'YES', 'wpsc_dgallery' ); ?>"
                                    unchecked_label="<?php _e( 'NO', 'wpsc_dgallery' ); ?>"
                                    type="checkbox"
                                    value="1"
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Horizontal Shadow', 'wpsc_dgallery' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Vertical Shadow', 'wpsc_dgallery' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Blur Distance -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Blur Distance', 'wpsc_dgallery' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Spread -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Spread Size', 'wpsc_dgallery' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Shadow Inset -->
                                <input
                                    ...
                                    checked_label="<?php _e( 'INNER', 'wpsc_dgallery' ); ?>"
                                    unchecked_label="<?php _e( 'OUTER', 'wpsc_dgallery' ); ?>"
                                    type="checkbox"
                                    value="inset"
                           ...
                           <input
                            ...
                            <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-box_shadow-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized box shadow settings', 'wpsc_dgallery'); ?>"><span>&nbsp;</span></a></div>   
                           </div>
                           <div style="clear:both;"></div>
                           </div>
						</td>
